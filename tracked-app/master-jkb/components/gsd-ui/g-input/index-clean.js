...
function ready() {
        var e = this;
        this.initSlots();
        var t = wx.getStorageSync("timestamp"), a = new Date().getTime();
        if (console.log(a - t), a - t <= 18e4) {
            ...
            var r = setInterval(function() {
                0 === i ? (clearInterval(r), wx.removeStorageSync("timestamp")) : (--i, e.setData({
                    _waitTime: i
                }));
            }, 1e3);
        }
...
function handleVerifyCode() {
            ...
            wx.setStorageSync("timestamp", a);
            var i = setInterval(function() {
                0 === t ? (clearInterval(i), wx.removeStorageSync("timestamp"), e.setData({
                    _waitTime: 0
                })) : (--t, e.setData({
                    _waitTime: t
                }));
