...
!function(e, n) {
    "object" == ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : (void 0).dayjs = n();
}(0, function() {
    var t = "millisecond", e = "second", n = "minute", r = "hour", s = "day", i = "week", a = "month", u = "year", o = /^(\d{4})-?(\d{1,2})-?(\d{0,2})(.*?(\d{1,2}):(\d{1,2}):(\d{1,2}))?.?(\d{1,3})?$/, c = /\[.*?\]|Y{2,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, h = {
        name: "en",
    ...
    var D = function() {
        ...
        return d.parse = function(t) {
            var e, n;
            this.$d = null === (e = t.date) ? new Date(NaN) : S.isUndefined(e) ? new Date() : e instanceof Date ? e : "string" == typeof e && /.*[^Z]$/i.test(e) && (n = e.match(o)) ? new Date(n[1], n[2] - 1, n[3] || 1, n[5] || 0, n[6] || 0, n[7] || 0, n[8] || 0) : new Date(e), 
            this.init(t);
        }, d.init = function(t) {
            ...
            var c = this, h = !!S.isUndefined(o) || o, d = function(t, e) {
                var n = p(new Date(c.$y, e, t), c);
                return h ? n : n.endOf(s);
            }, f = function(t, e) {
                return p(c.toDate()[t].apply(c.toDate(), h ? [ 0, 0, 0, 0 ].slice(e) : [ 23, 59, 59, 999 ].slice(e)), c);
            };
            ...
            var c = this;
            t = Number(t);
            var h, d = S.prettyUnit(o), f = function(e, n) {
            ...
            var e = this, n = t || "YYYY-MM-DDTHH:mm:ssZ", r = S.padZoneStr(this.$d.getTimezoneOffset()), s = this.$locale(), i = s.weekdays, a = s.months, u = function(t, e, n, r) {
            ...
            var h = S.prettyUnit(o), d = M(t), f = this - d, $ = S.monthDiff(this, d);
            switch (h) {
              case u:
                $ /= 12;
                break;
    ...
    return M.extend = function(t, e) {
        return t(e, D, M), M;
    }, M.locale = y, M.isDayjs = m, M.en = l[$], M;
});