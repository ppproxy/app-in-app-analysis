var e = require("../../../../@babel/runtime/helpers/objectSpread2"), a = require("../../../../@babel/runtime/helpers/defineProperty"), t = getApp(), i = t.request, o = (t.config, 
t.wxp, t.userStore, require("../../../../utils/mtaTarget.js").newspapers), n = require("../../../../utils/uitls.js").getPrevPageData, r = new (require("../../../../utils/jsencrypt.js").JSEncrypt)();

r.setPublicKey("-----BEGIN PUBLIC KEY-----MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC95A/NJpsjMG8i2Z7/+LkTptel3KLYS6O81NVAH3anwNcwtiYSujvoa1su1J2kXW9828hryaQevcVGDyiJFzJKAa3ckmI3PJIX7qAWopePrlUKHQt3XfjSSMDgjjHukRyF6Omu934jA5mqBOXUAGs/obdoAMl1yHCKBKdmeb929QIDAQAB-----END PUBLIC KEY-----"), 
Page({
    data: {
        scanWrong: !1,
        lulukouan: !1,
