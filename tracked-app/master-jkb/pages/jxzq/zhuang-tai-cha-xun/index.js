var t = getApp(), e = t.request, a = (t.config, t.wxp, t.userStore), i = require("../../../utils/util"), o = (i.apiErrorAndNavigateBack, 
i.apiError), n = (require("../../../utils/customErrors"), require("../../../utils/mtaTarget.js").newspapers);
