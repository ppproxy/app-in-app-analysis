...
i.wxp), s = i.userStore, r = (i.dayjs, require("../../../utils/util")), h = r.apiErrorAndNavigateBack, c = r.apiError, d = require("../../../utils/customErrors"), l = require("../../../config/index").jsonCdn, u = require("../../../utils/mtaTarget.js").newspapers;
