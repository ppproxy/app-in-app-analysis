var e, t = require("../../@babel/runtime/helpers/objectSpread2"), n = require("../../@babel/runtime/helpers/defineProperty"), a = getApp(), o = a.Anim, i = a.userStore, s = a.request, c = a.dayjs, r = a.config, h = a.wxp, g = (require("../../utils/genDid"), 
require("../../utils/sha256.js")), u = (require("../../utils/qrcode.js"), g.sha256_digest, 
require("../../utils/base64Src.js"), require("../../utils/bese64.js"), require("../../utils/mtaTarget.js").newspapers), d = require("../../utils/jsQR.js"), l = require("../../utils/checkUpdate").checkUpdate, f = (require("../../config/index").domain, 
wx.createCanvasContext("myCanvas")), x = require("../../utils/util"), w = x.apm, m = x.throttle, v = require("../../utils/util"), p = (v.apiErrorAndNavigateBack, 
v.apiError), S = v.audioContext, j = require("../../utils/customErrors"), y = require("../../config/index").jsonCdn, I = require("../../utils/realtimeLog"), _ = require("../../utils/crypto-js/crypto-js");
...
o.Page({
    data: (e = {
        ...
        boxWidth1: "",
        boxWidth2: ""
    }, n(e, "code", -1), n(e, "num", ""), n(e, "showModal", !1), n(e, "imgUrl", {}), 
    n(e, "windowWidth", ""), n(e, "scanWrong", !1), n(e, "daofangWrong", !1), n(e, "ma4Path", {}), 
    n(e, "showHeSuan", !1), n(e, "xianshi1sa", !1), n(e, "isHesuan", !1), n(e, "checkIDcard", !1), 
    n(e, "IdcardSixNum", ""), n(e, "shequRadioStatus", !0), n(e, "jiaogongRadioStatus", !1), 
    n(e, "showAdminType", !1), e),
    onShow: function() {
        var e = this;
    ...
    onTapAccess: m(function(e) {
        var t, n = this, a = new Date(), o = a.getFullYear() + "-" + a.getMonth() + "-" + a.getDate();
        try {
            t = wx.getStorageSync("img").img;
        } catch (e) {}
        u({
            eventId: "home_tap_Generation"
        }), i.confirmIsOnline().then(function(e) {
            if (e && 0 !== i.userInfo.isOpenWu || !t || o != wx.getStorageSync("br_timestamp")) {
                if (!wx.getStorageSync("wx-sessionid")) return void n.notLoginTips("/pages/gsd-ui/g-auth/face/face?url=/pages/jxzq/cha-xun-jie-guo/index");
                wx.showLoading({
                    title: "努力加载中",
                    mask: !0
                });
                var a = wx.getStorageSync("wx-logout");
                n.getLogin().then(function() {
                    if (wx.hideLoading(), !i.userInfo.isAuth) return wx.setStorageSync("wx-logout", a), 
                    void wx.showModal({
                        title: "提示",
                        content: "本次操作需要您进行登录验证",
                        success: function(e) {
                    ...
                    if (n.data.isReplace && null !== n.data.isReplace) return u({
                        eventId: "self_home_Accredit"
                    }), wx.hideLoading(), wx.setStorageSync("wx-logout", a), void wx.showModal({
                        title: "提示",
                        content: "本次操作需要您进行登录验证",
                        success: function(e) {
                            e.confirm && wx.navigateTo({
                    ...
                    s(e).then(function(e) {
                        n.setData({
                            time: e.healthStatus.time
                        }), n.resjson().then(function() {
                            if (wx.hideLoading(), null != e.healthStatus && e.healthStatus && "41" == e.healthStatus.code) return u({
                                eventId: "self_home_OutScope"
                            }), wx.hideLoading(), n.setData({
                                scanWrong: !0
                            }), void I.info({
                                eventMsg: "点击[本人健康码查询]入口，健康状态异常，状态码 41",
                                isAuth: i.userInfo.isAuth,
                                response: e
                            });
                            e.isLeaveOrEnterBj ? (wx.hideLoading(), u({
                                eventId: "self_home_GoSearchData"
                            }), "1" == n.data.isOpenBDCheck ? (u({
                                eventId: "declare_home_GetPhone"
                            }), n.setData({
                                isxianshi1: !0,
                                isChu: "22"
                            }), I.info({
                                eventMsg: "点击[本人健康码查询]入口，有离开过北京 businessTravel/check # success",
                                isAuth: i.userInfo.isAuth,
                                isOpenWu: i.userInfo.isOpenWu,
                                cdnOfflineStatus: n.data.isOpenBDCheck,
                                response: e
                            })) : wx.navigateTo({
                                url: "/pages/jxzq/cha-xun-jie-guo/index?isOpenBDCheck=" + n.data.isOpenBDCheck + "&code=" + e.isLeaveOrEnterBj + "time=" + e.healthStatus.time
                            })) : (u({
                                eventId: "self_home_GoSearchData"
                            }), wx.navigateTo({
                                url: "/pages/jxzq/cha-xun-jie-guo/index?isOpenBDCheck=" + n.data.isOpenBDCheck + "&code=" + e.isLeaveOrEnterBj
                            }));
                        });
                    }).catch(function(t) {
                        wx.hideLoading(), p(e, t, j.shixiang.businessTravelCheck.UncaughtExp), I.info({
                            eventMsg: "[本人健康码查询]，二次确认 差旅行程检查 接口失败 businessTravel/check # fail",
                            isAuth: i.userInfo.isAuth,
                            response: t
                        });
                    });
                    ...
                    wx.hideLoading(), I.info({
                        eventMsg: "[本人健康码查询]，二次确认 getLogin.catch 失败",
                        isAuth: i.userInfo.isAuth,
                        response: e
                    });
                });
    ...
    tarenTapAccess: m(function(e) {
        var t = this;
        if (u({
            eventId: "home_tap_GenerationQuery"
        }), wx.getStorageSync("wx-sessionid")) {
            wx.showLoading({
                title: "努力加载中",
                mask: !0
            });
            var n = wx.getStorageSync("wx-logout");
            this.getLogin().then(function() {
                if (wx.hideLoading(), t.data.isReplace && null !== t.data.isReplace) return u({
                    eventId: "replace_home_Accredit"
                }), wx.setStorageSync("wx-logout", n), void wx.showModal({
                    title: "提示",
                    content: "本次操作需要您进行登录验证",
                    success: function(e) {
                        e.confirm && wx.navigateTo({
                ...
                i.checkAuth("/pages/jxzq/zhuang-tai-cha-xun/index") && (u({
                    eventId: "replace_home_GoOthersList"
                }), wx.navigateTo({
                    url: "/pages/jxzq/zhuang-tai-cha-xun/index"
                }));
            });
        } else this.notLoginTips("/pages/gsd-ui/g-auth/face/face?dd=1&url=/pages/jxzq/zhuang-tai-cha-xun/index");
    }),
    scanCode: function() {
        u({
    ...
    panduan: m(function() {
        var e = this;
        u({
            eventId: "home_tap_RegisterBook"
        }), i.confirmIsOnline().then(function(t) {
            if ((!t || 0 === i.userInfo.isOpenWu) && wx.getStorageSync("dfRenci_qrCodeData").length > 0) {
                ...
                if (!i.userInfo.isAuth) return wx.getStorageSync("wx-sessionid") ? void e.getLogin().then(function() {
                    i.userInfo.isAuth ? (wx.showLoading({
                        title: "努力加载中",
                        mask: !0
                    }), e.dengjibu()) : (wx.hideLoading(), wx.showModal({
                        title: "提示",
                        content: "本次操作需要您进行登录验证",
                        success: function(e) {
                            e.confirm && wx.navigateTo({
                ...
                }) : void e.notLoginTips("/pages/gsd-ui/g-auth/face/face");
                wx.showLoading({
                    title: "努力加载中",
                    mask: !0
                }), e.dengjibu();
