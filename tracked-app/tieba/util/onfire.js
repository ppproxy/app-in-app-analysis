...
**/
/* jshint expr: true */ !function(root, factory) {
    if ((typeof module === "undefined" ? "undefined" : _typeof(module)) === "object" && module.exports) module.exports = factory(); else root.onfire = factory();
}(typeof window !== "undefined" ? window : undefined, function() {
    var __onfireEvents = {}, __cnt = 0, 
    // evnet counter
    string_str = "string", function_str = "function", hasOwnKey = Function.call.bind(Object.hasOwnProperty), slice = Function.call.bind(Array.prototype.slice);
    function _bind(eventName, callback, is_one, context) {
        if ((typeof eventName === "undefined" ? "undefined" : _typeof(eventName)) !== string_str || (typeof callback === "undefined" ? "undefined" : _typeof(callback)) !== function_str) {
    ...
    function _fire_func(eventName, args) {
        if (hasOwnKey(__onfireEvents, eventName)) {
            _each(__onfireEvents[eventName], function(key, item) {
                ...
                // when is one, delete it after triggle
                        });
        }
    }
    /**
  ...
  *
   ...
   *  onfire.un('my_event');
  **/    function un(event) {
        var eventName, key, r = false, type = typeof event === "undefined" ? "undefined" : _typeof(event);
        if (type === string_str) {
