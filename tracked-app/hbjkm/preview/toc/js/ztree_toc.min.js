...
!function(e) {
    ...
    function n(t, o) {
        ...
        e(o).attr("id", r), l(e(o).text()), t._header_offsets.push(e(o).offset().top - t.highlight_offset), 
        l("h offset =" + (e(o).offset().top - t.highlight_offset)), t._header_nodes.push({
            id: r,
            pId: n,
            name: e(o).text() || "null",
            open: !0,
    ...
    function s(t) {
        var o, r = function() {
            o && clearTimeout(o), o = setTimeout(function() {
                ...
                for (var r = 0, n = t._header_offsets.length; n > r; r++) if (t._header_offsets[r] >= o + 5) {
