...
!function(e, n) {
    "object" == ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : e.dayjs = n();
}(void 0, function() {
    ...
    var b = function() {
        ...
        return d.parse = function(t) {
            ...
            this.$d = null === (e = t.date) ? new Date(NaN) : M.isUndefined(e) ? new Date() : e instanceof Date ? e : "string" == typeof e && /.*[^Z]$/i.test(e) && (n = e.match(o)) ? new Date(n[1], n[2] - 1, n[3] || 1, n[5] || 0, n[6] || 0, n[7] || 0, n[8] || 0) : new Date(e), 
            this.init(t);
        }, d.init = function(t) {
            ...
            var c = this, h = !!M.isUndefined(o) || o, d = function(t, e) {
            ...
            var c = this;
            t = Number(t);
            var h = void 0, d = M.prettyUnit(o), f = function(e, n) {
            ...
            var e = this, n = t || "YYYY-MM-DDTHH:mm:ssZ", r = M.padZoneStr(this.$d.getTimezoneOffset()), s = this.$locale(), i = s.weekdays, a = s.months, u = function(t, e, n, r) {
            ...
            var h = M.prettyUnit(o), d = p(t), f = this - d, $ = M.monthDiff(this, d);
            switch (h) {
              case u:
                $ /= 12;
                break;
