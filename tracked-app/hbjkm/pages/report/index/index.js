...
var o, s = getApp(), r = s.Anim, m = (s.Event, s.resetTab), l = s.config, u = s.dayjs, c = s.request, d = s.requestHb, h = (s.systemInfo, 
s.wxp), g = require("../../../utils/util").chooseLocation, f = (require("../../../services/report"), 
...
r.Page({
    ...
    onLoad: function(t) {
        var n, i = this;
        if (1 == t.id) {
            var o = this.data.selfForm;
            o.questionThree = 2, this.setData({
                selfForm: o,
                agreement: [ "2" ]
            });
        }
        if (console.log(t), this.setData((n = {}, e(n, "selfForm.myUid", t.uid), e(n, "selfForm.username", decodeURIComponent(t.name)), 
        e(n, "selfForm.phone", t.phone), e(n, "selfForm.identity", t.identity), n)), this.getReportSubmitTime(t.isExpired), 
        console.error("onload options:", t), this.setData({
            currentType: t.type || "1"
        }), 1 == t.type || 2 == t.type) {
            var s = [ "健康自查上报", "上报我的健康信息", "为他人上报健康状况" ];
            console.log("title[options.type]", s[t.type]), wx.setNavigationBarTitle({
                title: s[t.type]
            }), this.setData({
        ...
        var r = null;
        r = "1" == t.type ? "fromDataKey" : "fromOtherKey", this.getStorage(r).then(function(e) {
            "1" == t.type ? i.setData({
    ...
    getRegionData: function() {
        ...
        console.log("调用区"), wx.showLoading(), 3 === a ? this.data.placesec.ins.forEach(function(a, n) {
    ...
    handleSelfSubmits: function() {
        console.log(this.data.selfForm);
        ...
        if ("" == this.data.selfForm.street) wx.showToast({
            ...
            this.setData({
                ...
                success: function(e) {
                    e.confirm ? d({
                        url: "/hbjkm/userHealth/saveReport",
                        method: "POST",
                        data: {
